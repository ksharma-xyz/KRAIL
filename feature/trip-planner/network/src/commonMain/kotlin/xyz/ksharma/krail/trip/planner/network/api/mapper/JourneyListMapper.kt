...
/**
 * Stub for the Phase C `JourneyList` (Wire-generated proto) → [TripResponse]
 ...
 * `RealTripPlanningService` compiles, but invoking it always throws —
 * which is fine because the proto branch is gated on
...
internal fun journeyListBytesToTripResponse(journeyListBytes: ByteArray): TripResponse {
    throw NotImplementedError(
        "JourneyList → TripResponse mapping pending. " +
